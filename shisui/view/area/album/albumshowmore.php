<!------------------start albumshowmore.php------------------>
<link href="view/area/album/css/creatalbum.css" rel="stylesheet" rev="stylesheet" type="text/css"/>
<div class='albumshow'>
<ul id="portfolio" class="portfolio portfolioLin">
					
				</ul>
</div>
<input id="RecordAlbumId" type="hidden" value=""/>    
<script>
var albummoreurl="http://localhost/shisui/action/getcategotymore.php?catid="+config.user.cat_id;
				  	$.get(albummoreurl,function(data){
	...
	$(".portfolioLin li span.change").unbind('click').bind('click',function(){
	...
	/*************删除相册*****************/
	$(".portfolioLin li span.delete").unbind('click').bind('click',function(){
		var DataDelete={};
